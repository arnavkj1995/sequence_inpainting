...
flags.DEFINE_string("out_dir", "outputs/",
                    "Directory name to save the logs [logs]")
...
flags.DEFINE_integer("z_dim", 128, "Dimension of latent vector.")
flags.DEFINE_integer("n_hidden", 100, "Dimension of latent vector.")
